      ...
      <main className="flex-grow py-20 font-sans text-sm sm:text-base text-gray-500 leading-relaxed">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="space-y-6">
            ...
            <p>
              Royale collects contact details, corporate designations, and technical specifications submitted via our bulk RFQ forms. This data is utilized solely to process your material requests, formulate supply quotes, and coordinate freight shipments.
            </p>

      ...
      <main className="flex-grow py-20 font-sans text-sm sm:text-base text-gray-500 leading-relaxed">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="space-y-6">
            ...
            <p>
              All quotations, bulk material supply contracts, and shipments coordinated by Royale are subject to our standard commercial terms. Specific billing terms, freight coordinates, and bulk discount schedules are finalized via signed sales agreements.
            </p>
            ...
            <p>
              Our polymer raw materials are guaranteed to conform to the physical, thermal, and mechanical ranges specified in our official Technical Datasheets (TDS) and manufacturer specifications. Royale is not liable for material failures resulting from improper processing on the client&apos;s manufacturing floor.
            </p>
